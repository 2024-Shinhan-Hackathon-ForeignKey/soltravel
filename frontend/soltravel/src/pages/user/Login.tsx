    ...
    <div className="w-full h-full bg-[#EFEFF5]">
      <div className="w-full h-full flex flex-col justify-center items-center">
        <div className="w-full h-[50%] flex flex-col justify-between items-center">
          ...
          <div className="w-[90%] h-[78%] flex flex-col items-center justify-around rounded-xl bg-white shadow-md">
          ...
          <div className="w-[90%] h-[18%] flex items-center justify-around rounded-xl bg-white shadow-md">
